...
this script splits test, train and valid sub dataaset as shown below. 
...
if __name__ == "__main__":
  try:
    images_dir = "./Tiled-Skin-Cancer-master/images/"
    masks_dir  = "./Tiled-Skin-Cancer-master/masks/"

    output_dir = "./Tiled-Skin-Cancer-ImageMask-Dataset-X/"
